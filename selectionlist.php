<!-- This is the file which allows TCU to view the list of selections made -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="text-primary"><i class="fa fa-users"></i> Selected Students</h4>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
             
              <li class="breadcrumb-item active">Selection List/View Selected Students</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
