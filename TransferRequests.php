<!-- This is the file that allows students to apply for transfer -->
<?php
      session_start();
      if ($_SESSION['role']!='3'){
      ...
      $sql1 = "select * from transfer where status='pending' and d_university='$oid'";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="text-primary"><i class="fa fa-download"></i> Pending Requests</h4>
          </div>
          <div class="col-sm-6">
