 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0 text-primary"><i class="fa fa-user"></i> Student</h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      ?>
                  <!-- About Me Box -->
                    ...
                    <div class="card-footer">
                      <a href="editstudent.php?id=<?php echo $row['user_id']; ?>" class="btn btn-outline-primary btn-block"><b>Edit Student</b></a>
                    </div>
                    <!-- /.card-body -->
                  </div>
                  <!-- /.card -->
