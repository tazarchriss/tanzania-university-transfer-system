<!-- This is the file which allows TCU to view the list of transfers made -->

<?php
      session_start();
   
      include_once "config/connection.php";
      $sql1 = "select * from transfer where status='Accepted'";
...
<head>
  ...
  <title>STS | Student Transfer</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="text-primary"><i class="fa fa-users"></i> Transfered Students</h4>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Manage Transfers</a></li>
              <li class="breadcrumb-item active">View Student Transfers</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
?>
<h3 class="text-center text-primary"> No Pending Transfer Requests Available ! </a>
...
<?php
  ...
  ?>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td><?php echo $i;  ?></td>
                    <td><?php echo $row3['fname']. "  " . $row3['sname']; ?></td>
