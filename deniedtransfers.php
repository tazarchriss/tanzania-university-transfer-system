<?php
     ...
     $sql1 = "select * from transfer where status='Denied' and d_university='$oid'";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="text-primary"><i class="fa fa-download"></i> Denied Requests</h4>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Manage Requests</a></li>
              <li class="breadcrumb-item active">Denied Requests</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              ?>
              <h3 class="text-center text-primary"> No Denied Transfer Requests Available ! </a>
