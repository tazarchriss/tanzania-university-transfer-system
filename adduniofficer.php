<!-- This is the file for adding university officer -->
...
<head>
  ...
  <title>STS| Add University Officer</title>
 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0 text-primary"><i class="fa fa-user-tie"></i> University Officer</h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Manage Users</a></li>
              <li class="breadcrumb-item active">Add University Officer</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="card-body pt-0">
           <!-- /.card-header -->
                 ...
                 <?php
                  ...
                  ?>
                <h3 class="text-success " style="margin-left:20px;">University Officer is successfully Added !</h3>
                  <?php     
                }
                ...
                <form id="quickForm" method="post" action="config/registration.php">
                  <div class="card-body">
                    ...
                    <div class="form-group col-md-6 float-left">
                        <label for="exampleInputEmail1">Working University</label>
                        <select name="university" class="bg-primary" id="" style="width:100%;height:40px;">
                                      <?php
                  ...
                  <div class="card-footer">
                    <button type="submit" class="btn btn-outline-primary btn-block" name="officer1">Add Officer</button>
